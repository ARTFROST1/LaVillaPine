            ...
            <div className="bg-gradient-to-r from-accent/10 to-accent/5 rounded-xl p-8 mb-8">
              <div className="text-center">
                ...
                <p className="text-secondary text-lg mb-6">
                  Для удобства наших гостей мы используем профессиональную платформу бронирования. 
                  Здесь будет интегрирована система бронирования третьей стороны для обеспечения 
                  безопасности платежей и удобства управления бронированиями.
                </p>
